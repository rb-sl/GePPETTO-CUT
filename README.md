...
This fork is the adaptation of the Contrastive Unpaired Translation to the [GePPETTO-DET generative framework](https://github.com/rb-sl/GePPETTO-DET). We add:
